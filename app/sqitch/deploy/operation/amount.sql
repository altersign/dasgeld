-- Deploy dasgeld:operation/amount to sqlite
--
...
INSERT INTO operation (operation_id, account_id, amount, description, tags, performed, created, parent_operation_id, is_actual, revision, editor_id)
    SELECT operation_id, account_id, summa, description, tags, performed, created, parent_operation_id, is_actual, revision, editor_id
    FROM tmp_operation;
